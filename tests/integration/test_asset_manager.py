...
from pixel_fight.resources import asset_manager
from pixel_fight.resources.asset_manager import AssetManager, DEFAULT_ASSET_ROOT
...
def test_asset_path_cannot_escape_root():
    ...
    with pytest.raises(ValueError, match="escapes"):
        manager.path(Path("..") / "pyproject.toml")
